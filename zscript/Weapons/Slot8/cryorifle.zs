...
// Ammo Class
Class CryoRifleAmmo : PB_WeaponAmmo
{
	default
	{
		Inventory.Amount 0;
		Inventory.MaxAmount PB_CryoRifleFullAmmo;
		Ammo.BackpackAmount 0;
		Ammo.BackpackMaxAmount PB_CryoRifleFullAmmo;
        ...
        switch(tic)
        {
            ...
            case 3:
                if(isBeam)
                {
                    ...
                    A_GunFlash();
                    A_Overlay(BEAM_FLASH, "BeamMuzzleFlash");
...
//////////////////////////// RELOAD ////////////////////////////////////////////////////////////////////////////////////
        Reload:
            ...
            // Code
            TNT1 A 0 PB_CheckReload("ReloadUnloaded",null,null,"Ready3","Ready3",PB_CryoRifleFullAmmo);
            TNT1 A 0 {
                A_StopSound(1);
                A_StopSound(6);
                A_ClearOverlays(7,9);
        ...
        ContinueReload:
            ...
            TNT1 A 0 {
                ...
                PB_AmmoIntoMag(invoker.ammo2.getClassName(),invoker.ammo1.getClassName(),PB_CryoRifleFullAmmo);
